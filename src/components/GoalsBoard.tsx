  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6">
        <header className="relative overflow-hidden rounded-2xl border border-white/[0.08] px-5 py-5 sm:px-7">
          <div
          ...
          />
          <p className="text-xs font-medium tracking-[0.14em] text-indigo-300 uppercase">
            {eyebrow}
          </p>
          <div className="mt-1 flex flex-wrap items-end justify-between gap-3">
            ...
            <Link
              href="/"
              className="flex items-center gap-1.5 rounded-full border border-white/12 bg-white/[0.05] px-3 py-1.5 text-xs text-zinc-300 transition hover:bg-white/10 hover:text-white"
            >
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1.55fr)_minmax(0,1fr)]">
          <section className="flex min-h-[26rem] flex-col overflow-hidden rounded-2xl border border-white/[0.08] bg-white/[0.025] lg:min-h-[34rem]">
            <NoteEditor
              noteKey={noteKey}
              placeholder={
                scope === "year"
          ...
          <section className="rounded-2xl border border-white/[0.08] bg-white/[0.025] p-4 sm:p-5">
            <h2 className="flex items-center gap-2 text-xs font-medium tracking-[0.14em] text-zinc-400 uppercase">
              <ImageIcon size={14} className="text-indigo-300" /> Pictures
            </h2>
